...
// $job2->modificarTitulo('Full Stack Developer');
// $job2->descripcion = 'PHP, JavaScript, CSS, SQL, PostgresQL';
$job2->meses = '5';

$job3 = new Job('','DBA');
// $job3->modificarTitulo('');
// $job3->descripcion = 'PHP, JavaScript, CSS, SQL, PostgresQL';
$job3->meses = '130';
